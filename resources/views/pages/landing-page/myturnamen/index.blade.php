                            ...
                            <table class="min-w-full divide-y divide-gray-300 table-fixed" style="background-color: #141432">
                                <thead style="background-color: #141432">
                                    <tr>
                                        ...
                                        <th scope="col" class="text-right px-6 py-2">
                                            <form action="{{ route('myturnamen.destroy', $turnamen->id) }}" method="POST">
                                                @method('DELETE')
                                                @csrf
                                                <button
                                                    class="bg-red-400 hover:bg-red-500 items-center border-0 py-2 px-7 focus:outline-none rounded-2xl font-medium text-base mt-6 lg:mt-0">Hapus</button>
                                            </form>
                                        </th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-200" style="background-color: #141432">
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <a href="{{ route('myturnamen.detail', [$turnamen->id]) }}"
                                            ...
                                            <a href="{{ route('myturnamen.edit', [$turnamen->id]) }}"
                                                class="bg-yellow-400 items-center  hover:bg-yellow-500 border-0 py-3 px-8 focus:outline-none rounded-2xl font-medium text-base mt-6 lg:mt-0">Edit</a>
                                        </td>
                                    </tr>
                                    <!-- More items... -->
                                </tbody>
