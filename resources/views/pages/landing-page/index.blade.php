            ...
            <div>
                <div class="mx-auto flex pt-12 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
                    ...
                    <div
                        ...
                        <div
                            class="inline-block items-center mx-auto lg:mx-0 lg:flex justify-center lg:space-x-8 md:space-x-2 sm:space-x-3 space-x-0 pt-20 px-40">

                            <a href="{{ route('auth') }}"
                                class="inline-flex font-semibold text-white text-base border-0 py-3 px-8 rounded-2xl mb-4 lg:mb-0 md:mb-0 focus:outline-none box-shadow-header-2-3"
