                ...
                <form action="{{ route('tim.update', $tim->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-3">
                                    <label for="nama_tim" class="block text-sm font-medium leading-6 text-gray-900">Nama
                                        Tim</label>
                                    <div class="mt-2">
                                ...
                                <div class="sm:col-span-3">
                                    <label for="stadion"
                                        class="block text-sm font-medium leading-6 text-gray-900">Stadion</label>
                                    <div class="mt-2">
                                        <input type="text" name="stadion" id="stadion"
                                            class="px-3 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                                            value="{{ $tim->stadion }}">
                                    </div>
                                </div>
                                ...
                                <input type="hidden" name="id_turnamenFK" value="{{ request()->route('id_turnamenFK') }}">
                            </div>
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        <a href="{{ route('tim.index', ['id_turnamenFK' => $turnamen->id]) }}"
                            class="text-sm font-semibold leading-6 text-gray-900">Kembali</a>
                        <button type="submit"
