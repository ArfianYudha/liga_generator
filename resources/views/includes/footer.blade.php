        <!-- footer -->
        <section id="footerSection" class="pb-6 fixed bottom-0 w-full " style="background-color: #141432">
            {{-- <section class="h-full pb-12 lg:px-24 md:px-16 sm:px-8 px-4" style="background-color: #141432"> --}}
            <footer class="h-full " style="font-family: 'Poppins', sans-serif">
                <div class="border-color-footer-2-3 mx-auto">
                    ...
                    <div
                        class="container mx-auto flex pt-6 flex-col lg:flex-row items-center space-y-5 lg:space-y-0 lg:px-24 md:px-16 sm:px-8 px-4">
                        <div class="flex title-font font-medium items-center text-gray-900 mb-4 lg:mb-0 md:mb-0 space-x-5"
                            style="cursor: pointer">
                            <a href="https://www.facebook.com/arfianyudha.pamungkas.5/">

                                <svg class="social-media-c-footer-2-3" width="30" height="30" viewBox="0 0 30 30"
                            ...
                            <a href="https://twitter.com/arfianyudha_">
                            ...
                            <a href="https://www.instagram.com/arfian.yudha/">

                                <svg class="social-media-p-footer-2-3" width="30" height="30" viewBox="0 0 30 30"
                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <nav class="mx-auto flex flex-wrap items-center text-base justify-center">
                            <a class="mr-5 footer-link-footer-2-3">Arfian</a>
                            <span class="mr-5">|</span>
                            <a class="mr-5 footer-link-footer-2-3">Yudha</a>
                            <span class="mr-5">|</span>
                            <a class="mr-5 footer-link-footer-2-3">Pamungkas</a>
                        </nav>

                        <nav class="flex lg:flex-row flex-col items-center text-base justify-center">
                            <p>Copyright © 2024 Liga Generator</p>
                        </nav>
                    </div>
                </div>
            </footer>
